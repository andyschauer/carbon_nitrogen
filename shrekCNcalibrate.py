...
if os.path.isdir(project_directory) is False:
    print('Project directory does not exist...exiting....')
    sys.exit()
...
sample_indices = list(set(all_indices) - set(knowns_indices))

recent_raw_file = file[-1]
recent_run_indices = np.where(file == recent_raw_file)[0]  # numpy where returns a tuple, [0] is required in this use case
...
Nqty_residual = np.concatenate(((Nqty[GA1['index']] - Amount[GA1['index']] * GA1['fractionN']) * 1000,
                                (Nqty[GA2['index']] - Amount[GA2['index']] * GA2['fractionN']) * 1000,
                                (Nqty[SA['index']] - Amount[SA['index']] * SA['fractionN']) * 1000))

Cqty_residual = np.concatenate(((Cqty[GA1['index']] - Amount[GA1['index']] * GA1['fractionC']) * 1000,
                                (Cqty[GA2['index']] - Amount[GA2['index']] * GA2['fractionC']) * 1000,
                                (Cqty[SA['index']] - Amount[SA['index']] * SA['fractionC']) * 1000))


GA1['d15N_residual'] = N_sam_d15N14N[GA1['index']] - np.nanmean(N_sam_d15N14N[GA1['index']])
GA2['d15N_residual'] = N_sam_d15N14N[GA2['index']] - np.nanmean(N_sam_d15N14N[GA2['index']])
SA['d15N_residual'] = N_sam_d15N14N[SA['index']] - np.nanmean(N_sam_d15N14N[SA['index']])
d15N_residual_std = np.std(np.concatenate([GA1['d15N_residual'], GA2['d15N_residual'], SA['d15N_residual']]))


GA1['d13C_residual'] = C_sam_d13C12C[GA1['index']] - np.nanmean(C_sam_d13C12C[GA1['index']])
GA2['d13C_residual'] = C_sam_d13C12C[GA2['index']] - np.nanmean(C_sam_d13C12C[GA2['index']])
SA['d13C_residual'] = C_sam_d13C12C[SA['index']] - np.nanmean(C_sam_d13C12C[SA['index']])
d13C_residual_std = np.std(np.concatenate([GA1['d13C_residual'], GA2['d13C_residual'], SA['d13C_residual']]))
...
GA1['d15N_AirN2_residual'] = d15N_AirN2[GA1['index']] - np.nanmean(d15N_AirN2[GA1['index']])
GA2['d15N_AirN2_residual'] = d15N_AirN2[GA2['index']] - np.nanmean(d15N_AirN2[GA2['index']])
SA['d15N_AirN2_residual'] = d15N_AirN2[SA['index']] - np.nanmean(d15N_AirN2[SA['index']])
d15N_AirN2_residual_std = np.std(np.concatenate([GA1['d15N_AirN2_residual'], GA2['d15N_AirN2_residual'], SA['d15N_AirN2_residual']]))


GA1['d13C_VPDB_residual'] = d13C_VPDB[GA1['index']] - np.nanmean(d13C_VPDB[GA1['index']])
GA2['d13C_VPDB_residual'] = d13C_VPDB[GA2['index']] - np.nanmean(d13C_VPDB[GA2['index']])
SA['d13C_VPDB_residual'] = d13C_VPDB[SA['index']] - np.nanmean(d13C_VPDB[SA['index']])
d13C_VPDB_residual_std = np.std(np.concatenate([GA1['d13C_VPDB_residual'], GA2['d13C_VPDB_residual'], SA['d13C_VPDB_residual']]))
...
figures[fig_n]['cap'] = f"""Figure {fig_n}. Nitrogen amount for each sample is calculated from the N2 peak area and from a linear equation
                            ...
                            The nitrogen amount of the other standards (GA1, GA2, SA) is also considered known and plotted here as such. We are
...
figures[fig_n]['fig'].circle(Amount[GA1['index']] * GA1['fractionN'], N_sam_AreaAll_blank_corr[GA1['index']], legend_label="GA1", size=8, color='green', alpha=0.8)
figures[fig_n]['fig'].circle(Amount[GA2['index']] * GA2['fractionN'], N_sam_AreaAll_blank_corr[GA2['index']], legend_label="GA2", size=8, color='blue', alpha=0.8)
figures[fig_n]['fig'].circle(Amount[SA['index']] * SA['fractionN'], N_sam_AreaAll_blank_corr[SA['index']], legend_label="SA", size=8, color='red', alpha=0.8)
...
if verbose:
    ...
    figures[fig_n]['fig'].circle(Analysis[GA1['index']], (Nqty[GA1['index']] - Amount[GA1['index']] * GA1['fractionN']) * 1000, legend_label="GA1", size=8, color='green', alpha=0.8)
    figures[fig_n]['fig'].circle(Analysis[GA2['index']], (Nqty[GA2['index']] - Amount[GA2['index']] * GA2['fractionN']) * 1000, legend_label="GA2", size=8, color='blue', alpha=0.8)
    figures[fig_n]['fig'].circle(Analysis[SA['index']], (Nqty[SA['index']] - Amount[SA['index']] * SA['fractionN']) * 1000, legend_label="SA", size=8, color='red', alpha=0.8)
...
figures[fig_n]['cap'] = f"""Figure {fig_n}. Carbon amount for each sample is calculated from the CO2 peak area and from a linear equation
                            generated as a least squares fit from peak area and measured amount of the quantity calibration standards (qtycal).
                            The carbon amount of the other standards (GA1, GA2, SA) is also considered known and plotted here as such. We are
...
figures[fig_n]['fig'].circle(Amount[GA1['index']] * GA1['fractionC'], C_sam_AreaAll[GA1['index']], legend_label="GA1", size=8, color='green', alpha=0.8)
figures[fig_n]['fig'].circle(Amount[GA2['index']] * GA2['fractionC'], C_sam_AreaAll[GA2['index']], legend_label="GA2", size=8, color='blue', alpha=0.8)
figures[fig_n]['fig'].circle(Amount[SA['index']] * SA['fractionC'], C_sam_AreaAll[SA['index']], legend_label="SA", size=8, color='red', alpha=0.8)
...
if verbose:
    ...
    figures[fig_n]['fig'].circle(Analysis[GA1['index']], (Cqty[GA1['index']] - Amount[GA1['index']] * GA1['fractionC']) * 1000, legend_label="GA1", size=8, color='green', alpha=0.8)
    figures[fig_n]['fig'].circle(Analysis[GA2['index']], (Cqty[GA2['index']] - Amount[GA2['index']] * GA2['fractionC']) * 1000, legend_label="GA2", size=8, color='blue', alpha=0.8)
    figures[fig_n]['fig'].circle(Analysis[SA['index']], (Cqty[SA['index']] - Amount[SA['index']] * SA['fractionC']) * 1000, legend_label="SA", size=8, color='red', alpha=0.8)
    figures[fig_n]['fig'].line([np.min(Analysis), np.max(Analysis)], [0, 0], line_width=3, color='black')
    figures[fig_n]['fig'].legend.location = 'top_left'
    ...
    figures[fig_n]['fig'].circle(Analysis[GA1['index']], GA1['d15N_AirN2_residual'], legend_label="GA1", size=8, color='green', alpha=0.8)
    figures[fig_n]['fig'].circle(Analysis[GA2['index']], GA2['d15N_AirN2_residual'], legend_label="GA2", size=8, color='blue', alpha=0.8)
    figures[fig_n]['fig'].circle(Analysis[SA['index']], SA['d15N_AirN2_residual'], legend_label="SA", size=8, color='red', alpha=0.8)
    ...
    figures[fig_n]['cap'] = f"""Figure {fig_n}."""
    figures[fig_n]['fig'] = figure(title="d15N residual", width=1200, height=600, background_fill_color="#fafafa")
    figures[fig_n]['fig'].circle(N_sam_AreaAll[GA1['index']], GA1['d15N_AirN2_residual'], legend_label="GA1", size=8, color='green', alpha=0.8)
    figures[fig_n]['fig'].circle(N_sam_AreaAll[GA2['index']], GA2['d15N_AirN2_residual'], legend_label="GA2", size=8, color='blue', alpha=0.8)
    figures[fig_n]['fig'].circle(N_sam_AreaAll[SA['index']], SA['d15N_AirN2_residual'], legend_label="SA", size=8, color='red', alpha=0.8)
    figures[fig_n]['fig'].yaxis.axis_label = 'd15N vs AirN2 residual (permil)'
    ...
    figures[fig_n]['fig'].circle(Analysis[GA1['index']], GA1['d13C_VPDB_residual'], legend_label="GA1", size=8, color='green', alpha=0.8)
    figures[fig_n]['fig'].circle(Analysis[GA2['index']], GA2['d13C_VPDB_residual'], legend_label="GA2", size=8, color='blue', alpha=0.8)
    figures[fig_n]['fig'].circle(Analysis[SA['index']], SA['d13C_VPDB_residual'], legend_label="SA", size=8, color='red', alpha=0.8)
    ...
    figures[fig_n]['fig'].circle(C_sam_AreaAll[GA1['index']], GA1['d13C_VPDB_residual'], legend_label="GA1", size=8, color='green', alpha=0.8)
    figures[fig_n]['fig'].circle(C_sam_AreaAll[GA2['index']], GA2['d13C_VPDB_residual'], legend_label="GA2", size=8, color='blue', alpha=0.8)
    figures[fig_n]['fig'].circle(C_sam_AreaAll[SA['index']], SA['d13C_VPDB_residual'], legend_label="SA", size=8, color='red', alpha=0.8)
...
figures[fig_n] = {}
figures[fig_n]['cap'] = f"""Figure {fig_n}."""
figures[fig_n]['fig'] = figure(title="d13C vs d15N", width=1200, height=600, background_fill_color="#fafafa")
figures[fig_n]['fig'].circle(d13C_VPDB[GA1['index']], d15N_AirN2[GA1['index']], legend_label="GA1", size=8, color='green', alpha=0.8)
figures[fig_n]['fig'].circle(d13C_VPDB[GA2['index']], d15N_AirN2[GA2['index']], legend_label="GA2", size=8, color='blue', alpha=0.8)
figures[fig_n]['fig'].circle(d13C_VPDB[SA['index']], d15N_AirN2[SA['index']], legend_label="SA", size=8, color='red', alpha=0.8)
figures[fig_n]['fig'].triangle(d13C_VPDB[sample_indices], d15N_AirN2[sample_indices], legend_label="samples", size=8, color='black', alpha=0.8)
...
figures[fig_n]['fig'].circle(Nqty[GA1['index']], d15N_AirN2[GA1['index']], legend_label="GA1", size=8, color='green', alpha=0.8)
figures[fig_n]['fig'].circle(Nqty[GA2['index']], d15N_AirN2[GA2['index']], legend_label="GA2", size=8, color='blue', alpha=0.8)
figures[fig_n]['fig'].circle(Nqty[SA['index']], d15N_AirN2[SA['index']], legend_label="SA", size=8, color='red', alpha=0.8)
...
figures[fig_n]['fig'].circle(Cqty[GA1['index']], d13C_VPDB[GA1['index']], legend_label="GA1", size=8, color='green', alpha=0.8)
figures[fig_n]['fig'].circle(Cqty[GA2['index']], d13C_VPDB[GA2['index']], legend_label="GA2", size=8, color='blue', alpha=0.8)
figures[fig_n]['fig'].circle(Cqty[SA['index']], d13C_VPDB[SA['index']], legend_label="SA", size=8, color='red', alpha=0.8)
...
summary_data_filename = f'shrekCN_calibrated_data.csv'
summary_data_file = os.path.join(project_directory, summary_data_filename)
summary_file_headers = ['Sample ID', 'Date', 'Analysis Number', 'Total Mass (mg)', 'Nitrogen mass (mg)', 'd15N vs AirN2 (permil)', 'Carbon mass (mg)', 'd13C vs VPDB (permil)']
...
body = f"""
    ...
    <h2>My data</h2>
    <div class="text-indent">
        <p>This technical stuff is fine and all but where are <strong><a href="data/{summary_data_filename}">my data</a></strong>?
        This summary data file contains sample IDs, dates of analyses, unique analysis numbers, total mass weighed for analysis,
    ...
    <div class="text-indent">
        <table>
            <tr><td>Total number of runs</td><td>{len(set(file))}</td></tr>
            <tr><td>Total number of analyses</td><td>{len(set(Analysis))}</td></tr>
            <tr><td>Total number of standards</td><td>{len(knowns_indices)}</td></tr>
            <tr><td>Total number of samples</td><td>{len(sample_indices)}</td></tr>
            <tr><td><br></td></tr>
            <tr><td>Number of blanks</a></td><td>{len(blank['index'])}</td></tr>
            <tr><td>Number of qtycal</a></td><td>{len(qtycal['index'])}</td></tr>
...
if os.path.exists(report_directory):
    shutil.move(report_directory, os.path.join(archive_directory, f"report_{int(dt.datetime.utcnow().timestamp())}"))
shutil.copytree(os.path.join(python_directory, 'report/'), report_directory)
shutil.rmtree(os.path.join(report_directory, 'figures/'))
...
shutil.copy2(os.path.join(python_directory, 'py_report_style.css'), report_directory)
shutil.copy2(os.path.join(project_directory, summary_data_filename), os.path.join(report_directory, 'data/'))

report_page = os.path.join(report_directory, f'shrekCN_calibration_summary.html')
